...
printlog,logfile,''
printlog,logfile,'Starting DELVERED_WCS  ',systime(0)
...
FOR i=0,ninputlines-1 do begin
  ...
  cmd1 = "DLV_WCSFIT,'"+file+"',pixscale="+strtrim(pixscale,2)+",refname='"+wcsrefname+"'"
...
;----------------------------
printlog,logfile,'Running DLV_WCSFIT on images'
...
printlog,logfile,'DELVERED_WCS Finished  ',systime(0)
