...
pro delvered_jointbrickcats_deep,brick,scriptsdir=scriptsdirs,irafdir=irafdir,workdir=workdir,redo=redo,logfile=logfile
...
if n_elements(brick) eq 0 then begin
  print,'Syntax - delvered_forcebrick_deep,brick,scriptsdir=scriptsdirs,irafdir=irafdir,workdir=workdir,redo=redo,logfile=logfile'
  return
endif
