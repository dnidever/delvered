...
;
; USAGE
;  IDL>dlv_wcsfit,'ccd1001.fits',up='N',left='E',pixscale=0.6995,cenra=90.55,cendec=-75.00
;
...
if ninput eq 0 then begin
  print,'Syntax - dlv_wcsfit,input,up=up,left=left,pixscale=pixscale,cenra=cenra,cendec=cendec,'
...
print,''
print,'============================================='
print,'RUNNING DLV_WCSFIT ON >>',filename,'<<'
print,'============================================='
...
if n_elements(refcat) eq 0 then begin
  print,'NO Reference Catalog Input: QUITING'
  return
endif
